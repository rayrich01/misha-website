...
export const metadata: Metadata = {
  title: 'Gallery | Misha Creations Houston',
  description:
    'View our portfolio of luxury murals, Venetian plaster & decorative painting projects in River Oaks, Memorial & Tanglewood.',
  alternates: {
    canonical: 'https://mishacreations.com/gallery',
  },
  openGraph: {
    title: 'Gallery | Misha Creations Houston',
    description:
      'View our portfolio of luxury murals, Venetian plaster & decorative painting projects in River Oaks, Memorial & Tanglewood.',
    url: 'https://mishacreations.com/gallery',
  },
}
